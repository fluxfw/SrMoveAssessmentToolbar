...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrMoveAssessmentToolbar\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrMoveAssessmentToolbar\x\UpdateVersion; 
...
